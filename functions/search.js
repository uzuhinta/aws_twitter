...
export const handler = async (event) => {
  ...
  switch (mode) {
    case 'People':
      return await searchPeople(userId, query, limit, nextToken);
    case 'Latest':
      return await searchLatest(query, limit, nextToken);
    default:
      throw new Error(
...
async function searchPeople(userId, query, limit, nextToken) {
...
async function searchLatest(query, limit, nextToken) {
